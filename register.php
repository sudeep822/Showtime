...
require_once("includes/classes/Constants.php");
 ...
 if(isset($_POST["submitButton"])) // same name as name in submit
 {
   ...
   $success = $account->register($firstName, $lastName, $username, $email, $email2, $password, $password2); //calling the register funtion for validating
       
   if($success)
   {
    $_SESSION["userLoggedIn"]=$username;  //session
